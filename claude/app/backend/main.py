...
def export(req: SelectionRequest) -> Response:
    ...
    try:
        result = build_selection(STATE.df, payload)
    except Exception as exc:
        print(f"[main] export selection failed: {exc}")
        traceback.print_exc()
        result = {
            "summary": [],
            "dynamic": [],
            "details": [],
            "totals": {},
            "analytics": [f"Не удалось построить выборку для экспорта: {exc}"],
            "risk_counts": {},
            "metric_meta": [],
            "params": payload,
        }
    try:
        ...
        print(f"[main] export excel failed: {exc}")
        traceback.print_exc()
        fallback_result = {
            "summary": [],
            "dynamic": [],
            "details": [],
            "totals": {},
            "analytics": [f"Не удалось сформировать полный Excel: {exc}"],
            "risk_counts": {},
            "metric_meta": [],
            "params": payload,
        }
        blob = build_excel(fallback_result)
